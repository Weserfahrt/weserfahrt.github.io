        ...
        this_form.submit(function(event)
        {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, request)
                {
                    ...
                    var message = "Dankeschön. Das hat geklappt.";
              ...
              //      }
                ...
                error: function (data, textStatus, request)
                {
                    ...
                    // show error message
                    var error_field_html = '<div class="alert">Das hat nicht funktioniert. Bitte versuchen Sie es (später) erneut.</div>';
 ...
 function validate_fields(form_object, single_field)
 {
    ...
    if (form_object !== undefined && form_object.length > 0)
    {
        ...
        form_fields_to_validate.each(function()
        {
            ...
            {
                if (field_value.match(/^[a-z0-9üöäß .\-,\/]+$/i) == null) single_field_error_details["message"] = "Invalid characters found.";
            }
            ...
            {
                if (field_value.match(/^[0-9]+$/i) == null) single_field_error_details["message"] = "Invalid characters found.";
            }
