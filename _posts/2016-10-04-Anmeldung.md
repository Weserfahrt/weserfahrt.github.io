...
<div>Teilnahme an folgender Strecke:
	 <div class="radio">
	  <label><input type="radio" name="tour" value="tour1"/>Tour 1: Oberweser – Hann. Münden bis Minden</label>
 	  <label><input type="radio" name="tour" value="tour2"/>Tour 2: Oberweser/Mittelweser – Hann. Münden bis Bremen</label>
	  <label><input type="radio" name="tour" value="tour3"/>Tour 3: Kurs Nord – Hann. Münden bis Nordenham</label>
	</div>
